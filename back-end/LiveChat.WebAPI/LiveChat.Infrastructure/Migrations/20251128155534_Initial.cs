        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeenOn = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MessageDeliveries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MessageDeliveries_AspNetUsers_ReceiverId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageDeliveries_ReceiverId",
                table: "MessageDeliveries",
                column: "ReceiverId");
